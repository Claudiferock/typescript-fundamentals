 ...
 */
let aa: number[] = [];  // without :number it'll become an array of nevers 
aa.push(33);
...
contactInfo.phone; // Not in the intersection
...
let other2ndContactInfo: HasEmail & HasPhoneNumber = {
  // we _must_ initialize it to a shape that's asssignable to HasEmail _and_ HasPhoneNumber
  name: "Mike",
  phone: 3215551212
};
